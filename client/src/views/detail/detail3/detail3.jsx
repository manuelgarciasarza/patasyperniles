...
function Detail() {
  ...
  function setCarrito() {
    try {
      const newProduct = {
        name: "Combinada de cerdo y ternera",
        amount: selectedOption,
        price: selectedPrice,
      };
      localStorage.setItem("combinada", JSON.stringify(newProduct));
    } catch (error) {
      console.log(error);
    }
    console.log(JSON.parse(localStorage.getItem("combinada")));
  }
  ...
  return (
    <div>
      ...
      <div>
        <div>
          <div>Combinada de cerdo y ternera</div>
          <div>
            <img src={pernil} alt="" />
          </div>
        </div>
